...
export const MODELS: Record<string, ModelInfo> = {
  "claude-opus-4-6":    { contextWindow: 200_000, maxOutput: 8096,  label: "Opus 4.6 (most capable)" },
  "claude-opus-4-5":    { contextWindow: 200_000, maxOutput: 8096,  label: "Opus 4.5" },
  "claude-opus-4-1":    { contextWindow: 100_000, maxOutput: 4096,  label: "Opus 4.1" },
  "claude-sonnet-4-6":  { contextWindow: 200_000, maxOutput: 8096,  label: "Sonnet 4.6 (fast + capable)" },
...
export const COPILOT_MODELS: Record<string, ModelInfo> = {
  ...
  "claude-3.5-sonnet":  { contextWindow: 200_000, maxOutput: 8096,  label: "Claude Sonnet 3.5 (via Copilot)" },
  "claude-3.5-haiku":   { contextWindow: 200_000, maxOutput: 8096,  label: "Claude Haiku 3.5 (via Copilot)" },
};

export const DEFAULT_MODEL = "claude-opus-4-6";

export function getModel(name: string): ModelInfo {
  return MODELS[name] ?? { contextWindow: 200_000, maxOutput: 8096, label: name };
}
